/// A DeltaEncoder can compress an array of integers to a compact byte representation. However
/// the input integers must be positive non-zero integers and strictly increasing (no duplicates,
/// always increasing in value). With these assumptions DeltaEncoder encodes the integers into
